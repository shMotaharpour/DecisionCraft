...
log-log view makes growth *rates* the message — the dashed reference is
linear growth ∝ t; curves bending below it sit in the proven log-regret
cone. Generated by `phase3_rl/make_figures.py` (same seeds as the evidence
run).*
