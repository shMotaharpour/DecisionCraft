...
902). The non-monotonicity promised in §6 is visible: exploration
periodically degrades the incumbent policy before recovering. Q-learning
edges out SARSA at the end (104.2% vs 103.8% of exact in the 2000-episode
evaluation), MC trails. Generated by `phase3_rl/lesson029_1_rl_foundations/make_figures_31.py`
(same agents and seeds as `lesson3_1_qlearning_inventory.py`).*
